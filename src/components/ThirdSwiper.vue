<template>
    <div>
        <ThirdSwiperFirst v-if="img_third.length > 0" :img_third="img_third" :msg="msg" @saveright="saveright"
            @saveleft="saveleft">
        </ThirdSwiperFirst>
        <ThirdSwiperSecond v-if="img_third.length > 0" :img_third="img_third" ref="thirdswipersecond" :msg="msg">
        </ThirdSwiperSecond>
