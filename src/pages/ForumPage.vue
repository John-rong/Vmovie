            ...
            <t-col :sm="10" :md="10" :lg="2" :xl="2" class="forum-left">
                <t-affix :offset-top="68" :offset-bottom="40" ref="affix">
                    ...
                    <div v-show="!isadd && !isdetail" >
                        ...
                        <input v-model="searchName" @dblclick="toSearchlist" @keyup.enter="toSearchlist" type="text" class="form-control"
                    ...
                    <div class="forum-single" v-show="!isadd" v-for="(item, index) in forumList" :key="index">
                        ...
                        <div>
                            ...
                            <ul v-if="!islike" class="like-icon">
                                <li @click="islike = true; $message.success('吼吼，你的赞被偷走喽！')"><span><i class='bx bxs-like bx-xs'></i></span></li>
                            </ul>
                        </div>
                    </div>

                </div>
                <t-button v-if="!isdetail" v-show="!isadd" @click="morelist" variant="text" theme="primary" size="large">加载更多</t-button>
